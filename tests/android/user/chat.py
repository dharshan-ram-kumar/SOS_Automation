...
def chat(driver):
    try:
        navigate_chat = wait_for_element(driver,MobileBy.ANDROID_UIAUTOMATOR,'new UiSelector().text("Chat")')
        navigate_chat.click()
        ...
        send_location = wait_for_element(driver,MobileBy.ANDROID_UIAUTOMATOR,'new UiSelector().text("").instance(1)')
        send_location.click()
        time.sleep(5)
